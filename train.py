...
def main(args=None):
    ...
    sampler = AspectRatioBasedSampler(dataset_train, batch_size=256, drop_last=False)
    dataloader_train = DataLoader(dataset_train, num_workers=3, collate_fn=collater, batch_sampler=sampler)

    if dataset_val is not None:
        sampler_val = AspectRatioBasedSampler(dataset_val, batch_size=256, drop_last=False)
